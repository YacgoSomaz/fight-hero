package Box2D.Collision
{
   ...
   internal class b2Simplex
   {
      ...
      public function ReadCache(param1:b2SimplexCache, param2:b2DistanceProxy, param3:b2Transform, param4:b2DistanceProxy, param5:b2Transform) : void
      {
         ...
         var _loc8_:Array = this.m_vertices;
         var _loc9_:int = 0;
      ...
      public function WriteCache(param1:b2SimplexCache) : void
      {
         ...
         var _loc2_:Array = this.m_vertices;
         var _loc3_:int = 0;
      ...
      public function Solve3() : void
      {
         ...
         var _temp_2:* = b2Math.Dot(_loc3_,_loc9_);
         var _loc11_:Number;
         ...
         var _loc19_:Number = b2Math.CrossVV(_loc4_,_loc9_);
         var _loc20_:Number = _loc19_ * b2Math.CrossVV(_loc2_,_loc3_);
