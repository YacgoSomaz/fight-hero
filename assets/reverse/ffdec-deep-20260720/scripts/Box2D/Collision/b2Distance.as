package Box2D.Collision
{
   ...
   public class b2Distance
   {
      ...
      public static function Distance(param1:b2DistanceOutput, param2:b2SimplexCache, param3:b2DistanceInput) : void
      {
         ...
         var _loc8_:b2Simplex = s_simplex;
         _loc8_.ReadCache(param2,_loc4_,_loc6_,_loc5_,_loc7_);
         var _loc9_:Array = _loc8_.m_vertices;
         var _loc10_:int = 20;
         var _loc11_:Array = s_saveA;
         var _loc12_:Array = s_saveB;
         var _loc13_:int = 0;
         var _loc14_:b2Vec2 = _loc8_.GetClosestPoint();
         var _loc15_:Number;
         var _loc16_:Number = _loc15_ = _loc14_.LengthSquared();
         var _loc19_:int = 0;
         while(_loc19_ < _loc10_)
         {
            ...
            if(_loc20_.LengthSquared() < Number.MIN_VALUE * Number.MIN_VALUE)
            {
               break;
            }
            _loc21_ = _loc9_[_loc8_.m_count];
            _loc21_.indexA = _loc4_.GetSupport(b2Math.MulTMV(_loc6_.R,_loc20_.GetNegative()));
