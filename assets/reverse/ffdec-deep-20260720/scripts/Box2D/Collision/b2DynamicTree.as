package Box2D.Collision
{
   ...
   public class b2DynamicTree
   {
      ...
      public function Rebalance(param1:int) : void
      {
         ...
         while(_loc2_ < param1)
         {
            ...
            while(_loc3_.IsLeaf() == false)
            {
               ...
               _loc4_ = uint(_loc4_ + 1 & 0x1F);
               if(2 == 3)
               {
                  break;
               }
            }
            var _loc5_:b2DynamicTree = this;
            var _loc6_:Number = _loc5_.m_path + 1;
            _loc5_.m_path = _loc6_;
      ...
      public function RayCast(param1:Function, param2:b2RayCastInput) : void
      {
         ...
         var _loc5_:b2Vec2 = b2Math.SubtractVV(_loc3_,_loc4_);
         _loc5_.Normalize();
         ...
         §§push(_loc12_);
         var _temp_2:* = _loc13_;
         var _loc19_:Number = _loc13_++;
         §§pop()[_loc19_] = this.m_root;
         while(_loc13_ > 0)
         {
            §§push(_loc12_);
            var _temp_4:* = _loc13_ - 1;
            _loc14_ = §§pop()[--_loc13_];
            if(_loc14_.aabb.TestOverlap(_loc9_) != false)
            {
               ...
               if(_loc17_ <= 0)
               {
                  if(_loc14_.IsLeaf())
                  {
                     ...
                     var _temp_8:* = Number(param1(_loc18_,_loc14_));
                  ...
                  else
                  {
                     §§push(_loc12_);
                     var _temp_9:* = _loc13_;
                     var _loc20_:Number = _loc13_++;
                     §§pop()[_loc20_] = _loc14_.child1;
                     §§push(_loc12_);
                     var _temp_11:* = _loc13_;
                     var _loc21_:Number = _loc13_++;
                     §§pop()[_loc21_] = _loc14_.child2;
                     if(2 == 3)
                     {
                        break;
                     }
      ...
      private function InsertLeaf(param1:b2DynamicTreeNode) : void
      {
         ...
         var _loc10_:b2DynamicTree = this;
         var _loc11_:Number = _loc10_.m_insertionCount + 1;
         _loc10_.m_insertionCount = _loc11_;
         if(this.m_root == null)
         {
            this.m_root = param1;
         ...
         var _loc5_:b2DynamicTreeNode = this.AllocateNode();
