package fl.controls
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol1008")]
   public class RadioButton extends LabelButton implements IFocusManagerGroup
   {
      ...
      private function setPrev(param1:Boolean = true) : void
      {
         ...
         var _loc2_:RadioButtonGroup = _group;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         var _loc4_:int;
         var _loc5_:int = _loc4_ = _loc2_.getRadioButtonIndex(this);
         if(_loc4_ != -1)
         {
            while(true)
            {
               ...
               if((Boolean(_loc6_)) && _loc6_.enabled)
               {
                  break;
               }
      ...
      private function setNext(param1:Boolean = true) : void
      {
         ...
         if(_loc4_ != -1)
         {
            while(true)
            {
               ...
               if((Boolean(_loc7_)) && _loc7_.enabled)
               {
                  break;
               }
      ...
      {
         var _loc1_:RadioButtonGroup = _group;
         if(_loc1_ != null)
         {
