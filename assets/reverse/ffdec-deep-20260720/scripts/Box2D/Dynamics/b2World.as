package Box2D.Dynamics
{
   ...
   public class b2World
   {
      ...
      public function DestroyBody(param1:b2Body) : void
      {
         ...
         var _loc10_:b2World = this;
         var _loc11_:Number = _loc10_.m_bodyCount - 1;
         _loc10_.m_bodyCount = _loc11_;
      }
      ...
      public function CreateJoint(param1:b2JointDef) : b2Joint
      {
         ...
         var _temp_1:* = this;
         var _loc6_:b2World = this;
         var _loc7_:Number = _loc6_.m_jointCount + 1;
         _loc6_.m_jointCount = _loc7_;
      ...
      public function AddController(param1:b2Controller) : b2Controller
      {
         ...
         param1.m_world = this;
         var _loc2_:b2World = this;
         var _loc3_:Number = _loc2_.m_controllerCount + 1;
         _loc2_.m_controllerCount = _loc3_;
         return param1;
      }
      ...
      public function QueryAABB(param1:Function, param2:b2AABB) : void
      {
         ...
         broadPhase = null;
         WorldQueryWrapper = null;
         callback = param1;
         aabb = param2;
         WorldQueryWrapper = function(param1:*):Boolean
         {
            §§push(§§findproperty(callback));
            if(37 == 34)
            {
               return;
            }
            return §§pop().callback(broadPhase.GetUserData(param1));
         };
      ...
      public function QueryShape(param1:Function, param2:b2Shape, param3:b2Transform = null) : void
      {
         ...
         WorldQueryWrapper = function(param1:*):Boolean
         {
            ...
            var _loc2_:b2Fixture = §§pop().GetUserData(param1) as b2Fixture;
      ...
      public function RayCastOne(param1:b2Vec2, param2:b2Vec2) : b2Fixture
      {
         ...
         result = null;
         RayCastOneWrapper = null;
         point1 = param1;
         point2 = param2;
         RayCastOneWrapper = function(param1:b2Fixture, param2:b2Vec2, param3:b2Vec2, param4:Number):Number
         {
            §§push(§§findproperty(result));
            if(37 == 34)
            {
               return;
            }
      ...
      b2internal function SolveTOI(param1:b2TimeStep) : void
      {
         ...
         var _temp_1:* = this.m_island;
         var _loc9_:b2Island = this.m_island;
         _loc9_.Initialize(this.m_bodyCount,b2Settings.b2_maxTOIContactsPerIsland,b2Settings.b2_maxTOIJointsPerIsland,null,this.m_contactManager.m_contactListener,this.m_contactSolver);
         var _loc10_:Array = s_queue;
         _loc2_ = this.m_bodyList;
         while(_loc2_)
         {
            _loc2_.m_flags &= ~b2Body.e_islandFlag;
         ...
         while(true)
         {
            ...
            while(_loc11_ = _loc11_.m_next, 2 != 3);
      ...
      b2internal function DrawJoint(param1:b2Joint) : void
      {
         ...
         switch(§§pop())
         {
            case 0:
               ...
               break;
            case 1:
               var _temp_1:* = param1 as b2PulleyJoint;
