...
- 原 `ScoreBar` 1462 已导出为 184×45；原经验容器 1477 为 397×16。1462 仍由 `hud-scorebar-1462.png` 在原锚点绘制；1477 已改由其原 1474/1475/699 子项、918 matrix/颜色变换和 981 字体在 `(200.55,588.45)` 重建，静态 `hud-expholder-1477.png` 不再作为运行时经验显示。
