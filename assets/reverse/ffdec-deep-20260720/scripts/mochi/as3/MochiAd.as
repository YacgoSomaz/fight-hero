   ...
   public class MochiAd
   {
      ...
      public static function doOnEnterFrame(param1:MovieClip) : void
      {
         ...
         var f:Function = function(param1:Object):void
         {
            ...
            if(§§pop() in mc && Boolean(mc.onEnterFrame))
            {
               mc.onEnterFrame();
            }
            else
      ...
      public static function showPreGameAd(param1:Object) : void
      {
         ...
         var DEFAULTS:Object = {
            ...
            {
               §§push(§§findproperty(trace));
               if(37 == 34)
               {
                  return;
               }
               §§pop().trace("[MochiAd] Couldn\'t load an ad, make sure your game\'s local security sandbox is configured for Access Network Only and that you are not using ad blocking software");
            },
         ...
         chk.fadeFunction = function():void
         {
            ...
            var _loc1_:Number = §§pop() * (1 - (getTimer() - this.fadeout_start) / this.fadeout_time);
            if(_loc1_ > 0)
            {
         ...
         f = function(param1:Event):void
         {
            ...
            §§pop().target.removeEventListener(param1.type,arguments.callee);
            complete = true;
            if(unloaded)
            {
               MochiAd.unload(clip);
         ...
         mc.adjustProgress = function(param1:Number):void
         {
            ...
            var _loc2_:Object = §§pop()._mochiad_wait;
         ...
         mc.rpcTestFn = function(param1:String):Object
         {
            ...
            §§pop().trace("[MOCHIAD rpcTestFn] " + param1);
            return param1;
         };
         sendHostProgress = false;
         mc.sendHostLoadProgress = function(param1:String):void
         {
            §§push(§§findproperty(sendHostProgress));
            if(37 == 34)
            {
               return;
            }
            §§pop().sendHostProgress = true;
         };
         chk["onEnterFrame"] = function():void
         {
            ...
            var _loc7_:Number = Math.min(1,options.progress_override(_loc1_));
            if(_loc7_ == 1)
            {
               complete = true;
            }
            ...
            if(!chk.showing)
            {
               _loc12_ = Number(this.parent._mochiad_ctr.contentLoaderInfo.bytesTotal);
               if(_loc12_ > 0)
               {
                  chk.showing = true;
                  chk.started = getTimer();
      ...
      public static function showClickAwayAd(param1:Object) : void
      {
         ...
         chk["onEnterFrame"] = function():void
         {
            ...
            if(!chk.showing)
            {
               _loc4_ = Number(this.parent._mochiad_ctr.contentLoaderInfo.bytesTotal);
               if(_loc4_ > 0)
               {
                  chk.showing = true;
                  _loc3_ = true;
      ...
      public static function load(param1:Object) : MovieClip
      {
         ...
         loader.contentLoaderInfo.addEventListener(IOErrorEvent.IO_ERROR,function(param1:IOErrorEvent):void
         {
            ...
            §§pop().trace("[MochiAds] Blocked URL");
         });
         if(!options.skip)
         {
            loader.load(req);
