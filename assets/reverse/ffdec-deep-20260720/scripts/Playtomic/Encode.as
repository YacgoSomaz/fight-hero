   ...
   internal final class Encode
   {
      ...
      internal static function Base64Decode(param1:String) : ByteArray
      {
         ...
         while(_loc6_ < _loc7_)
         {
            do
            {
               _loc2_ = int(decodeChars[param1.charCodeAt(_loc6_++) & 0xFF]);
            }
            ...
            do
            {
               _loc3_ = int(decodeChars[param1.charCodeAt(_loc6_++) & 0xFF]);
            }
            ...
            while(true)
            {
               _loc4_ = param1.charCodeAt(_loc6_++) & 0xFF;
               if(_loc4_ == 61)
               {
                  break;
               }
               ...
               if(!(_loc6_ < _loc7_ && _loc4_ == -1))
               {
                  ...
                  while(true)
                  {
                     _loc5_ = param1.charCodeAt(_loc6_++) & 0xFF;
                     if(_loc5_ == 61)
                     {
                        break;
                     }
         ...
         while(_loc7_ < param1.height)
         {
            ...
            if(!param1.transparent)
            {
               ...
               while(_loc6_ < param1.width)
               {
                  ...
                  _loc4_.writeUnsignedInt(uint((_loc5_ & 0xFFFFFF) << 8 | 0xFF));
                  _loc6_++;
               }
            }
            else
            {
               ...
               while(_loc6_ < param1.width)
               {
                  ...
                  _loc4_.writeUnsignedInt(uint((_loc5_ & 0xFFFFFF) << 8 | _loc5_ >>> 24));
                  _loc6_++;
               }
            }
            _loc7_++;
      ...
      private static function rhex(param1:Number) : String
      {
         ...
         while(_loc3_ <= 3)
         {
            _loc2_ += hex_chr.charAt(param1 >> _loc3_ * 8 + 4 & 0x0F) + hex_chr.charAt(param1 >> _loc3_ * 8 & 0x0F);
            _loc3_++;
         }
         return _loc2_;
      }
      ...
      private static function str2blks_MD5(param1:String) : Array
      {
         ...
         _loc3_[_loc2_ * 16 - 2] = _loc5_ & 0xFF;
         _loc3_[_loc2_ * 16 - 2] |= (_loc5_ >>> 8 & 0xFF) << 8;
         _loc3_[_loc2_ * 16 - 2] |= (_loc5_ >>> 16 & 0xFF) << 16;
         _loc3_[_loc2_ * 16 - 2] |= (_loc5_ >>> 24 & 0xFF) << 24;
         return _loc3_;
      }
