package Box2D.Collision.Shapes
{
   ...
   public class b2PolygonShape extends b2Shape
   {
      ...
      public function b2PolygonShape()
      {
         ...
         super();
         b2internal::m_type = b2internal::e_polygonShape;
      ...
      b2internal static function ComputeOBB(param1:b2OBB, param2:Array, param3:int) : void
      {
         var _loc4_:int = 0;
         ...
         var _loc5_:Array = new Array(param3 + 1);
         _loc4_ = 0;
         while(_loc4_ < param3)
         {
      ...
      override public function ComputeAABB(param1:b2AABB, param2:b2Transform) : void
      {
         ...
         param1.lowerBound.y = _loc6_ - m_radius;
         param1.upperBound.x = _loc7_ + m_radius;
         param1.upperBound.y = _loc8_ + m_radius;
      }
      ...
      override public function ComputeSubmergedArea(param1:b2Vec2, param2:Number, param3:b2Transform, param4:b2Vec2) : Number
      {
         ...
         {
            _loc12_ = (_loc12_ + 1) % this.m_vertexCount;
            if(_loc12_ == _loc14_)
            {
               _loc22_ = _loc18_;
            }
      ...
      public function GetSupport(param1:b2Vec2) : int
      {
         ...
         {
            var _temp_1:* = this.m_vertices[_loc4_].x * param1.x + this.m_vertices[_loc4_].y * param1.y;
