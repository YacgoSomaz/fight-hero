package Box2D.Dynamics.Joints
{
   ...
   public class b2PulleyJoint extends b2Joint
   {
      ...
      public function GetLength1() : Number
      {
         ...
         var _loc1_:b2Vec2 = m_bodyA.GetWorldPoint(this.m_localAnchor1);
      ...
      public function GetLength2() : Number
      {
         ...
         var _loc1_:b2Vec2 = m_bodyB.GetWorldPoint(this.m_localAnchor2);
      ...
      override b2internal function InitVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         var _loc20_:Number = this.m_constant - _loc18_ - this.m_ratio * _loc19_;
         if(_loc20_ > 0)
         {
      ...
      override b2internal function SolveVelocityConstraints(param1:b2TimeStep) : void
      {
         ...
         if(this.m_state == e_atUpperLimit)
         {
            ...
            var _temp_1:* = this.m_impulse - _loc20_;
