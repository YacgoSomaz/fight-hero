...
// M4 child is shifted 10px left and 24px up inside the composite so its
// magazine sits in the Medic hand; keep the ballistic origin on its new tip.
const RIFLE_BARREL_TIP = Object.freeze({ x: 66, y: -16 });
