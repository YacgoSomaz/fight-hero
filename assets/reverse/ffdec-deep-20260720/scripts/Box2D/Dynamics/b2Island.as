package Box2D.Dynamics
{
   ...
   public class b2Island
   {
      ...
      public function Initialize(param1:int, param2:int, param3:int, param4:*, param5:b2ContactListener, param6:b2ContactSolver) : void
      {
         ...
         _loc7_ = int(this.m_bodies.length);
         while(_loc7_ < param1)
         {
         ...
         _loc7_ = int(this.m_contacts.length);
         while(_loc7_ < param2)
         {
         ...
         _loc7_ = int(this.m_joints.length);
         while(_loc7_ < param3)
         {
      ...
      public function Solve(param1:b2TimeStep, param2:b2Vec2, param3:Boolean) : void
      {
         ...
         var _loc8_:b2ContactSolver = this.m_contactSolver;
      ...
      public function SolveTOI(param1:b2TimeStep) : void
      {
         ...
         while(_loc2_ < param1.positionIterations)
         {
            ...
            while(_loc3_ < this.m_jointCount)
            {
               _loc12_ = Boolean(this.m_joints[_loc3_].SolvePositionConstraints(b2Settings.b2_contactBaumgarte));
               _loc11_ &&= _loc12_;
               _loc3_++;
               if(2 == 3)
               {
      ...
      public function AddBody(param1:b2Body) : void
      {
         ...
         §§push(this.m_bodies);
         var _loc3_:b2Island;
         var _temp_2:* = (_loc3_ = this).m_bodyCount;
         §§push(_temp_2);
      ...
      public function AddContact(param1:b2Contact) : void
      {
         ...
         var _loc3_:b2Island;
         var _temp_2:* = (_loc3_ = this).m_contactCount;
         §§push(_temp_2);
         var _loc4_:Number = _temp_2 + 1;
      ...
      public function AddJoint(param1:b2Joint) : void
      {
         ...
         §§push(this.m_joints);
         var _loc3_:b2Island;
         var _temp_2:* = (_loc3_ = this).m_jointCount;
         §§push(_temp_2);
         var _loc4_:Number = _temp_2 + 1;
