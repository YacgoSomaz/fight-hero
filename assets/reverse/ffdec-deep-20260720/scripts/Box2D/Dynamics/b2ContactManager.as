package Box2D.Dynamics
{
   ...
   public class b2ContactManager
   {
      ...
      public function AddPair(param1:*, param2:*) : void
      {
         ...
         var _loc8_:b2Contact = this.m_contactFactory.Create(_loc3_,_loc4_);
         ...
         var _loc11_:b2World = this.m_world;
         var _loc12_:Number = _loc11_.m_contactCount + 1;
         _loc11_.m_contactCount = _loc12_;
      }
      ...
      public function Destroy(param1:b2Contact) : void
      {
         ...
         var _loc6_:b2ContactManager = this;
         var _loc7_:Number = _loc6_.m_contactCount - 1;
         _loc6_.m_contactCount = _loc7_;
      }
