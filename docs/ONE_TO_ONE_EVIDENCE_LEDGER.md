...
- 原 `ScoreBar` 1462 已导出为 184×45；原经验容器 1477 为 397×16。导出物目前位于 `private-assets/hud-core-export/`，必须经 TDD 接入到 `public/assets/original-swf/` 后才可将 HUD 条目改为“已接入”。
