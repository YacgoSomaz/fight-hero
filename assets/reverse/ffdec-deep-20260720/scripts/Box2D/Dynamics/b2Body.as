package Box2D.Dynamics
{
   ...
   public class b2Body
   {
      ...
      private function connectEdges(param1:b2EdgeShape, param2:b2EdgeShape, param3:Number) : Number
      {
         ...
         var _temp_1:* = b2Math.AddVV(param1.GetDirectionVector(),param2.GetDirectionVector());
         var _loc7_:b2Vec2 = b2Math.AddVV(param1.GetDirectionVector(),param2.GetDirectionVector());
         _loc7_.Normalize();
         var _loc8_:Boolean = b2Math.Dot(param1.GetDirectionVector(),param2.GetNormalVector()) > 0;
      ...
      public function CreateFixture(param1:b2FixtureDef) : b2Fixture
      {
         ...
         var _loc4_:b2Body = this;
         var _loc5_:Number = _loc4_.m_fixtureCount + 1;
         _loc4_.m_fixtureCount = _loc5_;
         _loc2_.m_body = this;
      ...
      public function DestroyFixture(param1:b2Fixture) : void
      {
         ...
         param1.m_body = null;
         param1.m_next = null;
         var _loc10_:b2Body = this;
         var _loc11_:Number = _loc10_.m_fixtureCount - 1;
         _loc10_.m_fixtureCount = _loc11_;
         this.ResetMassData();
      }
      ...
      public function GetDefinition() : b2BodyDef
      {
         ...
         _loc1_.allowSleep = (this.m_flags & e_allowSleepFlag) == e_allowSleepFlag;
         _loc1_.angle = this.GetAngle();
         _loc1_.angularDamping = this.m_angularDamping;
         _loc1_.angularVelocity = this.m_angularVelocity;
         _loc1_.fixedRotation = (this.m_flags & e_fixedRotationFlag) == e_fixedRotationFlag;
         _loc1_.bullet = (this.m_flags & e_bulletFlag) == e_bulletFlag;
         _loc1_.awake = (this.m_flags & e_awakeFlag) == e_awakeFlag;
      ...
      public function Split(param1:Function) : b2Body
      {
         ...
         while(_loc8_)
         {
            if(param1(_loc8_))
            {
               ...
               var _loc14_:b2Body = _loc5_;
               var _loc15_:Number = _loc14_.m_fixtureCount - 1;
               _loc14_.m_fixtureCount = _loc15_;
               _loc8_.m_next = _loc6_.m_fixtureList;
               _loc6_.m_fixtureList = _loc8_;
               _loc14_ = _loc6_;
               _loc15_ = _loc14_.m_fixtureCount + 1;
               _loc14_.m_fixtureCount = _loc15_;
      ...
      public function Merge(param1:b2Body) : void
      {
         ...
         while(_loc2_)
         {
            ...
            var _loc12_:b2Body = param1;
            var _loc13_:Number = _loc12_.m_fixtureCount - 1;
            _loc12_.m_fixtureCount = _loc13_;
            _loc2_.m_next = this.m_fixtureList;
            this.m_fixtureList = _loc2_;
            var _temp_2:* = this;
            _loc12_ = this;
            _loc13_ = _loc12_.m_fixtureCount + 1;
            _loc12_.m_fixtureCount = _loc13_;
      ...
      public function SetMassData(param1:b2MassData) : void
      {
         ...
         if(param1.I > 0 && (this.m_flags & e_fixedRotationFlag) == 0)
         {
