package Box2D.Dynamics.Contacts
{
   ...
   public class b2ContactFactory
   {
      ...
      b2internal function InitializeRegisters() : void
      {
         ...
         {
            this.m_registers[_loc1_] = new Array(b2Shape.e_shapeTypeCount);
            _loc2_ = 0;
      ...
      public function Destroy(param1:b2Contact) : void
      {
         ...
         var _loc6_:b2ContactRegister = _loc4_ = this.m_registers[_loc2_][_loc3_];
         var _loc7_:Number = _loc6_.poolCount + 1;
         _loc6_.poolCount = _loc7_;
